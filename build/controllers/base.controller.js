...
var BaseController = /** @class */ (function () {
    function BaseController() {
         ...
         * @returns fn
         */
        this.catchAsyn = function (fn) {
            return function (req, res, next) {
                fn(req, res, next).catch(function (err) {
                    return apiError_core_1.ApiError.handle(err, res);
                });
            };
        };
        /**
         ...
         */
        this.createDocument = function (postData, Model, res) { return __awaiter(_this, void 0, void 0, function () {
            var newDoc, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Model.create(postData)];
                    case 1:
                        newDoc = _a.sent();
